...
function acfpb_scripts() {
	...
	wp_enqueue_script('acfpb_moby', get_template_directory_uri() . '/inc/moby/moby.js', array(), '1.0', 'all');
...
function my_acf_init() {
	$gmkey = get_field('gmkey', 'option');
    acf_update_setting('google_api_key', $gmkey);
}
